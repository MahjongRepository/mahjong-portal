...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        lobbies_dict = {
            "般": {"name": "Кю лобби", "up_points": 0, "down_points": 0},
            "上": {"name": "Перводан", "up_points": 0, "down_points": 0},
            "特": {"name": "Втородан", "up_points": 0, "down_points": 0},
            "鳳": {"name": "Феникс", "up_points": 0, "down_points": 0},
        }
