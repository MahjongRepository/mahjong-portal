...
urlpatterns = [
    ...
    url(
        r"^(?P<slug>[\w\-]+)/(?P<year>\d+)/(?P<month>\d+)/(?P<day>\d+)/$",
        player_details,
        name="player_details",
    ),
    url(
        r"^(?P<slug>[\w\-]+)/tenhou/$",
        player_tenhou_details,
        name="player_tenhou_details",
    ),
    url(r"^(?P<slug>[\w\-]+)/ms/$", player_ms_details, name="player_ms_details"),
    url(
        r"^(?P<slug>[\w\-]+)/tournaments/$",
        player_tournaments,
        name="player_tournaments",
    ),
    url(
        r"^(?P<slug>[\w\-]+)/(?P<rating_slug>[\w\-]+)/details/$",
        player_rating_details,
    ...
    url(
        r"^(?P<slug>[\w\-]+)/(?P<rating_slug>[\w\-]+)/changes/$",
        player_rating_changes,
